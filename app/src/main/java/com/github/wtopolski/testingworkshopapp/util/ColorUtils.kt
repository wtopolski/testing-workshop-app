...
class ColorUtils {
    ...
    fun mix(vararg colors: String): String {
        var commonRed = 0
        var commonGreen = 0
        var commonBlue = 0
        ...
        colors.forEach {
            ...
            commonRed += Color.red(colorInt)
            commonGreen += Color.green(colorInt)
            commonBlue += Color.blue(colorInt)
        }

        commonRed /= colors.size
        commonGreen /= colors.size
        commonBlue /= colors.size

        return String.format("#%02X%02X%02X", commonRed, commonGreen, commonBlue)
    }
